...
una reconstrucción real sobrevivió **<1%**. Si se editó en la otra máquina, **tiene que viajar de vuelta**,
emparejado con el grafo contra el que se escribió. "Derivado" es propiedad del fichero, no de la carpeta. Dos subcomandos cierran el círculo (la memoria no viaja en el delta
por defecto):
